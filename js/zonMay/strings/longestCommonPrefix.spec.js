import {
    longestCommonPrefix,
    longestCommonPrefixRefactor,
    longestCommonPrefixDivide,
    longestCommonPrefixMemo
...
describe('finding longest common prefix', () => {
    it('should return "fl" for ["flower","flow","flight"]', () => {
        ...
        // expect(longestCommonPrefixRefactor(input)).toBe(result);
        // expect(longestCommonPrefixDivide(input)).toBe(result);
        // expect(longestCommonPrefixMemo(input)).toBe(result);
    });
